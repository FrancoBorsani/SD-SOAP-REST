<template>
  <nav class="navbar navbar-light" v-if="currentUser.username">
    ...
    <!--Logo-->
    <router-link class="navbar-brand py-0 pl-5" to="/envios">
    ...
    <div class="nav-item dropdown ml-auto pr-5">
      ...
      <div v-else>
        ...
        >
          <img
            src="https://www.findcollab.com/img/user-folder/5da9aea95eb62user.png"
            width="30"
          />
        </span>

        <div
          class="dropdown-menu ml-auto user"
  ...
  <nav class="navbar navbar-light" v-else>
    <div class="navbar-brand py-0 pl-5" to="/envios">
      <img src="@/assets/fi-logo.svg" width="50" height="50" />
    </div>
  </nav>
</template>
